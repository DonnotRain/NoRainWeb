...
$(function () {
    ...
    easyloader.load(['treegrid', 'combobox', 'form', 'dialog', 'messager', 'treegrid', 'combotree'], InitialFunc);
});
...
window.Initialize = {
    ...
    loadDataGrid: function () {
        $("#dgMain").treegrid({
            ...
            columns: [[
              { field: 'ControlID', title: '编号', width: 80, align: 'center' },
       {
           field: 'FunctionType', title: '功能类型', width: 50, align: 'center', formatter: function (value, row, index) {
               ...
               switch (value) {
                   ...
                   { field: 'Sort', title: '排序', width: 30, align: 'center' },
                    { field: 'Path', title: '模块Url', width: 100, align: 'center' },
                       {
            ...
            loadFilter: function (items) {
                ...
                $("#PID").combotree({
                    ...
                    treeField: 'Name',
                    width: $("#PID").width(),
                    data: combogridFilter(items, "-1", "children", "ID", "PID", "Name"),
                    editable: false,
