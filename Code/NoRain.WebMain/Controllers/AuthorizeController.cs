...
namespace MainWeb.Controllers
{
    public class AuthorizeController : Controller
    {
        ...
        public ActionResult Login(LoginModel login)
        {
            ...
            {
                Response.AppendCookie(new HttpCookie("UserName", System.Web.HttpUtility.UrlEncode(user.FullName.ToString())));
                Response.AppendCookie(new HttpCookie("UserId",System.Web.HttpUtility.UrlEncode( user.ID.ToString())));
