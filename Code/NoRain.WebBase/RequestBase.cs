    ...
    public class RequestBase
    {
        ...
        private void SetField(FieldInfo field, HttpQueryStringAttribute attribute)
        {
            ...
            if (attribute.IsRequired)
            {
                ...
                {
                    throw new ApiException(ResponseCode.必须参数缺少, attribute.Name);
                }
            }
            ...
            else
            {
                ...
                {
                    throw new ApiException(ResponseCode.参数值错误, attribute.Name);
                }
            }
        }
        ...
        private void SetFieldValue(FieldInfo field, object obj, string name, Type conversionType)
        {
            ...
            {
                throw new ApiException(ResponseCode.参数值格式错误, name);
            }
        }
    }
}
