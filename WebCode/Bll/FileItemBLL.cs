...
namespace HuaweiSoftware.WMS.BLL
{
    public class FileItemBLL : CommonBLL, IFileItemBll
    {
        ...
        private readonly string uploadPath = CommonToolkit.ApiConfig.UploadPath;
        ...
        public FileItem UploadFile()
        {
            ...
            if (fileCollection.Count > 0)
            {
                for (int i = 0; i < fileCollection.Count; i++)
                {
                    ...
                    fileItem.ExtensionName = Path.GetExtension(filename);// 文件扩展名
                    ...
                    fileItem.FileSize = httpPostedFile.InputStream.Length / 1024;
                }
            }
            //var isSingle = false;
