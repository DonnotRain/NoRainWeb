PlugFunctions.Sale.Leave = function () {
    ...
    var currentUrl = rootPath + "/API/StatisticsLeave/";
    //全局变量声明
    var vars = {
    ...
    var Initialize = {
        loadDataGrid: function () {
            $("#dgMain").datagrid({
                ...
                showFooter: true,
                columns: [[
                { field: 'UserName', title: '请假人', width: 100, align: 'center' },
                {
                    field: 'Duration', title: '请假时间', width: 100, align: 'center'
                },
                {
                    field: 'LeaveCount', title: '请假次数', width: 60, align: 'center'
                }
                ]]
