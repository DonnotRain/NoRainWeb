PlugFunctions.Sale.Infomation = function () {

    var currentUrl = rootPath + "/API/Infomation/";
    //全局变量声明
    var vars = {
    ...
    var Initialize = {
        loadDataGrid: function () {
            $("#dgMain").datagrid({
                ...
                {
                    field: 'CreateTime', title: '提交时间', width: 120, align: 'left', formatter: timeFormatter
                },
                { field: 'Detail', title: '描述', width: 220, align: 'left' },
